package com.gedo.tutorialmod.sound;
...
public class ModSounds {
    ...
    public static final DeferredSoundType MAGIC_BLOCK_SOUNDS = new DeferredSoundType(2f, 1f,
            ModSounds.MAGIC_BLOCK_BREAK,ModSounds.MAGIC_BLOCK_STEP, ModSounds.MAGIC_BLOCK_PLACE, ModSounds.MAGIC_BLOCK_HIT,
